 ...
 * @param machine Machine to add to
 */
void Machine1Factory::BasketballGoal(std::shared_ptr<Machine> machine)
{
 ...
 */
void Machine1Factory::DominoesOnBeam(std::shared_ptr<Machine> machine, wxPoint2DDouble position)
{
